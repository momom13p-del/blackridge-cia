...
io.on('connection', (socket) => {
  ...
  // خطوات إنشاء شخصية جديدة (إضافة اسم الشخصية وإرسال الطلب ليكون أكثر من شخصية)
  ...
  // تعديل وتحديث راتب الرتبة مع إظهار إشعار بتغير الراتب واعتماد المبلغ للرتبة
  socket.on('bank:setRankSalary', (payload, cb) => {
    ...
    saveState();
    const successMsg = `تم تغيير وتحديث راتب الرتبة (${rankLabel(rank)}) إلى ${amount} بنجاح، وتطبيق التعديل على جميع أعضاء الرتبة.`;
  ...
  // إضافة دعم لإضافة أي مبلغ لأي شخصية (متاحة للقائد والسينيور كوماندر)
  ...
  // ميزة حذف أماكن الأشخاص في الخريطة للقائد، السينيور كوماندر، والهاي كوماندر
  ...
  /* =====================================================
     SOS SYSTEM (إظهار كود العسكري والرتبة الحقيقية وحذف البلاغ)
  ===================================================== */
...
httpServer.listen(PORT, () => {
  console.log('=================================================');
  console.log(' BLACK RIDGE CITY CIA SYSTEM (UPDATED)');
