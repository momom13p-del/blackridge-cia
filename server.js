  ...
  try {
    ...
    const state = {
      ...
      cia_chats: {
        ...
        private: parsed.cia_chats?.private && typeof parsed.cia_chats.private === 'object'
          ? parsed.cia_chats.private
          : {}
      }
    };
...
user.bank.salaryEnabled =
  user.bank.salaryEnabled !== false;

user.bank.frozen =
  user.bank.frozen === true;

user.bank.identityVerified =
  user.bank.identityVerified === true;

  if (!Number.isFinite(Number(user.bank.salary))) {
    user.bank.salary = SYSTEM.defaultSalary;
  }
...
function makePublicCode(rank) {
  ...
  do {
    ...
    state.cia_users.some((u) => u.publicCode === value)
  );
...
for (const currentSocket of io.sockets.sockets.values()) {
  const currentUser = currentSocket.userId
    ? getUserById(currentSocket.userId)
    : null;

  if (isChief(currentUser)) {
    currentSocket.emit(
      'join:request:new',
      queueItem
    );
        ...
        return ok(
          cb,
          {
            ...
            message:
              'تم إنشاء الحساب وإرسال طلب الاعتماد إلى CIA CHIEF.'
          }
        );
      } catch (error) {
        return no(
    ...
    (payload, cb) => {
      try {
        ...
        if (!account) {
          return no(
            cb,
            'لا يوجد حساب بهذه الشخصية. أنشئ الحساب أولاً.'
          );
        }

        if (
          state.cia_queue.some(
            (q) =>
              lower(q.name) ===
              lower(name)
          )
        ...
        const queueItem = {
          ...
          initialCode:
            account.pendingPrimary.initialCode,
        ...
        account.pendingPrimary.requestedAt =
          queueItem.createdAt;
    ...
    (payload, cb) => {
      try {
        ...
        if (
          ...
          return no(
            cb,
            'هذه الصلاحية متاحة لـ CIA CHIEF فقط.'
          );
        }
        ...
        if (!account) {
          return no(
            cb,
            'الحساب المرتبط بالطلب غير موجود.'
          );
        }
        ...
        account.pendingPrimary.approvedAt =
          now();

        account.pendingPrimary.secretCode =
          secretCode;
    ...
    (payload, cb) => {
      ...
      if (isChief(user)) {
        ...
        addAuditLog(
          ...
          user,
          newUser,
          'تم إنشاء شخصية جديدة مباشرة للقيادة.'
        );
      ...
      addAuditLog(
        ...
        user,
        null,
        `طلب ${user.name} إنشاء شخصية ${name}.`
      );
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (!user) {
        return no(
          cb,
          'اسم الشخصية أو كود الدخول غير صحيح.'
        );
      }
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (
        ...
        return no(
          cb,
          'هذه الصلاحية متاحة للقيادة فقط.'
        );
      }
      ...
      addAuditLog(
        'تعديل بيانات القيادة',
        actor,
        actor,
        'تم تعديل اسم القائد/القيادي.'
      );
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      addAuditLog(
        ...
        actor,
        actor,
        'تم تعديل البيانات الإضافية للقيادة.'
      );
    ...
    (payload, cb) => {
      try {
        ...
        if (
          ...
          return no(
            cb,
            'تسليم القيادة متاح لـ CIA CHIEF فقط.'
          );
        }
        ...
        if (
          ...
          return no(
            cb,
            'لا يمكن تسليم القيادة لشخص مفصول.'
          );
        }
        ...
        if (
          ...
          return no(
            cb,
            'هذه الشخصية لا تصلح لتسلم القيادة بهذه الطريقة.'
          );
        }
        ...
        addAuditLog(
          ...
          actor,
          target,
          'تم تحويل منصب CIA CHIEF إلى الشخصية المحددة.'
        );
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (
        ...
        return no(
          cb,
          'ليست لديك صلاحية إدارة الأعضاء.'
        );
      }
      ...
      if (
        ...
        return no(
          cb,
          'ليست لديك صلاحية إدارة هذا العضو.'
        );
      }
      ...
      if (
        ...
        if (
          ...
          addAuditLog(
            ...
            actor,
            target,
            `تم تغيير الرتبة من ${rankLabel(oldRank)} إلى ${rankLabel(newRank)}.`
          );
      ...
      if (
        ...
        if (
          ...
          return no(
            cb,
            'لا يمكنك تغيير كود دخول هذا العضو.'
          );
        }
        ...
        addAuditLog(
          ...
          actor,
          target,
          'تم تغيير كود الدخول العسكري للشخصية.'
        );
      ...
      if (
        ...
        if (
          ...
          return no(
            cb,
            'لا يمكنك تغيير كود الظهور لهذا العضو.'
          );
        }
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (
        ...
        return no(
          cb,
          'ليست لديك صلاحية فصل هذا العضو.'
        );
      }
      ...
      addAuditLog(
        ...
        actor,
        target,
        'تم فصل العضو من الخدمة مع الاحتفاظ بسجله.'
      );
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (
        ...
        return no(
          cb,
          'ليست لديك صلاحية إعادة هذا العضو.'
        );
      }
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (!isChief(actor)) {
        return no(
          cb,
          'عرض حسابات جميع الأعضاء متاح لـ CIA CHIEF فقط.'
        );
      }
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (
        ...
        return no(
          cb,
          'رقم الحساب البنكي يجب أن يكون 4 رموز على الأقل ويحتوي على أرقام/أحرف فقط.'
        );
      }
      ...
      if (duplicate) {
        return no(
          cb,
          'رقم الحساب البنكي مستخدم من شخصية أخرى.'
        );
      }
  ...
  (payload, cb) => {
    ...
    if (
      ...
      return no(cb, 'لا تملك صلاحية تعديل الرواتب.');
    }

    if (!isChief(actor) && rank !== 'AGENT') {
      return no(cb, 'يمكنك تعديل رواتب Agent فقط.');
    }

    const targets = state.cia_users.filter(
      (user) => normalizeRank(user.rank) === rank
    );
...
socket.on(
  ...
  (payload, cb) => {
    ...
    if (
      ...
      return no(
        cb,
        'تجميد الحساب والخصم متاحان لـ CIA CHIEF فقط.'
      );
    }
    ...
    if (action === 'freeze') {
      target.bank.frozen = true;
    }

    else if (action === 'unfreeze') {
      target.bank.frozen = false;
    }

    else if (action === 'stop-salary') {
      target.bank.salaryEnabled = false;
    }

    else if (action === 'start-salary') {
      target.bank.salaryEnabled = true;
    }
      ...
      if (
        amount >=
        Number(target.bank.balance)
      ) {
        target.bank.balance = 0;
      } else {
    ...
    addAuditLog(
      ...
      actor,
      target,
      `تم تنفيذ الإجراء ${action} على الحساب البنكي.`
    );
...
if (
  ...
  return no(
    cb,
    'الحساب البنكي مجمد ولا يمكن السحب منه.'
  );
}
...
if (
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (
        ...
        return no(
          cb,
          'صرف راتب فوري متاح للقيادة فقط.'
        );
      }
      ...
      if (
        ...
        return no(
          cb,
          'لا تملك صلاحية صرف راتب هذه الشخصية.'
        );
      }
      ...
      if (paid === null) {
        return no(
          cb,
          'لا يمكن الصرف الآن. يجب أن تكون الشخصية مسجلة دخول ولم تستلم راتبها خلال آخر 24 ساعة.'
        );
      }
    ...
    (payload, cb) => {
      try {
        ...
        if (
          ...
          return no(
            cb,
            'إنشاء المهام متاح لـ CIA CHIEF وSenior Commander CIA وHigh Commander.'
          );
        }
        ...
        if (
          !commander ||
          commander.suspended ||
          commander.activeService === false
        ) {
          return no(
            cb,
            'كود قائد العملية غير صالح.'
          );
        }
        ...
        for (
          ...
          if (
            !member ||
            member.suspended ||
            member.activeService === false
          ) {
            return no(
              cb,
              `كود العضو ${code} غير صالح.`
            );
          }
        }
        ...
        state.cia_operations.unshift(
          op
        );

        state.cia_operations =
          state.cia_operations.slice(
            0,
            500
          );
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      if (
        ...
        return no(
          cb,
          'إدارة الطاقم متاحة للقيادة وHigh Commander.'
        );
      }
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      const i =
        state.cia_operations.findIndex(
          (x) =>
            x.id === id
        );
  ...
  socket.on(
    ...
    (payload, cb) => {
      ...
      /*
        Force public military identity only.
        Remove any accidental real name.
      */
...
process.on(
  ...
  (error) => {
    console.error(
      '[BLACK RIDGE] Uncaught exception:',
      error
    );
  }
);
...
process.on(
  ...
  (reason) => {
    console.error(
      '[BLACK RIDGE] Unhandled rejection:',
      reason
    );
  }
);
...
httpServer.listen(
  ...
  () => {
    ...
    console.log(
      ' LOGIN / LEADERSHIP / RADIO / SOS: READY'
    );
